...
Encrypt/Decrypt one message on the CPU without assigned roles to the threads. This part is left up to the logic level optimization assembly/machine level code optimization.
